...
class App:
    ...
    def __init__(self, callback):
        ...
        tk.Label(self.app, text="SQL Query:", font=("Helvetica", 20)).place(x = 40, y = 250)
        ...
        tk.Label(self.app, text="SQL Query Result:", font=("Helvetica", 20)).place(x = 40, y = 400)
        ...
        tk.Label(self.app, text="Result:", font=("Helvetica", 20)).place(x = 40, y = 550)
